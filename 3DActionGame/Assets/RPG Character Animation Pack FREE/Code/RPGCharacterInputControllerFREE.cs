...
namespace RPGCharacterAnims{
	...
	public class RPGCharacterInputControllerFREE : MonoBehaviour{
		...
		void Inputs(){
            ...
            inputLightHit = false;
            inputDeath = false;
            inputAttackL = Input.GetKeyDown(KeyCode.Z);
			inputAttackR = Input.GetKeyDown(KeyCode.X);
			inputSwitchUpDown = Input.GetKeyDown(KeyCode.W);
			inputStrafe = Input.GetKeyDown(KeyCode.LeftShift);
